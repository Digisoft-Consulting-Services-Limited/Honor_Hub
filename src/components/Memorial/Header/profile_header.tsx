    ...
    <div className="bg-[url('/img/candle.png')] bg-cover bg-center lg:h-screen/2 text-white relative">
      ...
      <div className="container mx-auto px-6 lg:py-20 flex flex-col items-center text-center h-full relative lg:flex-row lg:justify-between lg:items-center">
        <div className="flex flex-col lg:text-center py-6">
          <h1 className="text-5xl font-semibold p-5">{profile.name}</h1>
          <p className="text-3xl mt-2">{profile.years}</p>
        </div>
        <div className="relative z-20 lg:absolute lg:right-20 lg:top-1/2 lg:transform lg:-translate-y-1/2 -mb-20 sm:-mb-20 lg:mb-10">
          <div className="overflow-hidden rounded-lg border-4 border-white w-50 h-64">
            <img
